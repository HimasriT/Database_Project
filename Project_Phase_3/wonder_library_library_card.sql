...
CREATE TABLE `library_card` (
  ...
  CONSTRAINT `library_card_ibfk_1` FOREIGN KEY (`MemberID`) REFERENCES `member` (`Member_ID`) ON DELETE CASCADE
...
INSERT INTO `library_card` VALUES (1,'P001'),(2,'P002'),(3,'P003'),(4,'P004'),(5,'P006'),(6,'P008'),(7,'P009');
